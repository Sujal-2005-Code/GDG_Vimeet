              ...
              <div className="order-2 lg:order-1">
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    <img src="/images/nav-logo.svg" alt="GDG ViMEET Logo" className="h-7 w-auto" />
                    <h2 className="text-white text-2xl md:text-3xl font-bold">GDG ViMEET</h2>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-gray-300 space-y-1">
                      <p>Vishwaniketan Institute of Management</p>
                      <p>Entrepreneurship and Engineering Technology</p>
                      <p>Khalapur, Navi Mumbai</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-4">
                      <a 
                        href="https://github.com/gdgvimeet" 
                        target="_blank" 
                      ...
                      <a 
                        href="https://www.instagram.com/gdgvimeet?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-gray-300 hover:text-white transition-colors"
                      ...
                      <a 
                        href="https://linkedin.com/company/gdgvimeet" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-gray-300 hover:text-white transition-colors"
                        aria-label="LinkedIn"
              ...
              <div className="order-1 lg:order-2">
                <div className="rounded-xl border border-white/10 bg-white/5 p-3 md:p-4">
                  ...
                  <div className="rounded-lg overflow-hidden border border-white/10 bg-black/40">
                    <iframe
                      src="https://docs.google.com/forms/d/e/1FAIpQLSd9hYJ48DFNnZtp-3kJKhGfYw-pR0M2-Nf47TYAGSJnH_7toA/viewform?embedded=true"
                      width="100%"
                      height="500"
                      frameBorder="0"
                      marginHeight="0"
                ...
                <div className="mt-4">
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                    <h3 className="text-white font-semibold md:text-lg">Vikram Devadiga</h3>
                    <p className="text-white/70 text-sm mb-2">Web-Dev Team Lead</p>
                    <p className="text-white/80 text-xs">Contact: <a href="tel:+91" className="hover:text-white">7977789337</a></p>
                    <p className="text-white/80 text-xs">Email: <a href="mailto:devadigavikram1@gmail.com" className="hover:text-white">devadigavikram1@gmail.com</a></p>
                  </div>
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                    <h3 className="text-white font-semibold md:text-lg">Vivek Suryawanshi</h3>
                    <p className="text-white/70 text-sm mb-2">Web-Dev Team Co-Lead</p>
                    <p className="text-white/80 text-xs">Contact: <a href="tel:+91" className="hover:text-white">7020984802</a></p>
                    <p className="text-white/80 text-xs">Email: <a href="mailto:vivek@example.com" className="hover:text-white">viveksuryawanshi491@gmail.com</a></p>
                  </div>
